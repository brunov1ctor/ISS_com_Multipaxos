...
var file_contentiontest_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x38, 0x5a, 0x36, 0x67,
...
func file_contentiontest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contentiontest_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_contentiontest_proto_msgTypes[1].Exporter = func(v any, i int) any {
