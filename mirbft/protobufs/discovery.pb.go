...
var file_discovery_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x00, 0x42, 0x38,
...
func file_discovery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_discovery_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*Noop); i {
			case 0:
				return &v.state
			case 1:
		...
		file_discovery_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_discovery_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*Stop); i {
			case 0:
				return &v.state
			case 1:
