...
###############################################################################
# Scripts auxiliares e lista de código a copiar para o master
###############################################################################
...
# Diretório local da árvore de código, relativo a deployment/
local_code_dir=".."
