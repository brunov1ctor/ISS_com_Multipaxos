...
# Push config files.
exec-start peers scp-output-0000-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0000.yml config/config.yml
...
exec-start 1client scp-output-0000-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0000.yml config/config.yml
...
exec-start peers scp-output-0000-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0000-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
exec-start 1client scp-output-0000-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0000-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
# Push config files.
exec-start peers scp-output-0001-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0001.yml config/config.yml
...
exec-start 1client scp-output-0001-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0001.yml config/config.yml
...
exec-start peers scp-output-0001-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0001-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
exec-start 1client scp-output-0001-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0001-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
# Push config files.
exec-start peers scp-output-0002-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0002.yml config/config.yml
...
exec-start 1client scp-output-0002-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0002.yml config/config.yml
...
exec-start peers scp-output-0002-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0002-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
exec-start 1client scp-output-0002-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0002-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
# Push config files.
exec-start peers scp-output-0003-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0003.yml config/config.yml
...
exec-start 1client scp-output-0003-config.log stubborn-scp.sh 10 -i $ssh_key_file $own_public_ip:iss/experiment-config/config-0003.yml config/config.yml
...
exec-start peers scp-output-0003-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0003-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
...
exec-start 1client scp-output-0003-logs.log stubborn-scp.sh 10 -i $ssh_key_file experiment-output-0003-slave-__id__.tar.gz $own_public_ip:iss/current-deployment-data/raw-results/
