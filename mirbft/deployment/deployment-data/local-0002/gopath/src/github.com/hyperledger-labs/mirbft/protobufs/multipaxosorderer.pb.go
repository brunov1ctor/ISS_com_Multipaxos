...
type MPxInstanceId struct {
	...
	Lead          uint64                 `protobuf:"varint,2,opt,name=lead,proto3" json:"lead,omitempty"` // nodeId do líder proponente (opcional)
...
type MPxValue struct {
	...
	Batch         []byte                 `protobuf:"bytes,2,opt,name=batch,proto3" json:"batch,omitempty"` // protobuf-encoded Batch; vazio => ⊥
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_multipaxosorderer_proto_rawDesc = "" +
	...
	"\x06ballot\x18\x02 \x01(\x04R\x06ballot\"^\n" +
	"\n" +
	"MPxPromise\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.protobufs.MPxInstanceIdR\x02id\x12\x16\n" +
	"\x06ballot\x18\x02 \x01(\x04R\x06ballot\x12\x0e\n" +
	"\x02ok\x18\x03 \x01(\bR\x02ok\"x\n" +
	"\tMPxAccept\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.protobufs.MPxInstanceIdR\x02id\x12\x16\n" +
	"\x06ballot\x18\x02 \x01(\x04R\x06ballot\x12)\n" +
	"\x05value\x18\x03 \x01(\v2\x13.protobufs.MPxValueR\x05value\"_\n" +
	"\vMPxAccepted\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.protobufs.MPxInstanceIdR\x02id\x12\x16\n" +
	"\x06ballot\x18\x02 \x01(\x04R\x06ballot\x12\x0e\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.protobufs.MPxValueR\x05value\"\x8c\x02\n" +
	"\x06MPxMsg\x121\n" +
	...
	"\x04typeB\x0eZ\f./;protobufsb\x06proto3"
...
var file_multipaxosorderer_proto_depIdxs = []int32{
	...
	0,  // 3: protobufs.MPxAccept.id:type_name -> protobufs.MPxInstanceId
	1,  // 4: protobufs.MPxAccept.value:type_name -> protobufs.MPxValue
	0,  // 5: protobufs.MPxAccepted.id:type_name -> protobufs.MPxInstanceId
	0,  // 6: protobufs.MPxCommit.id:type_name -> protobufs.MPxInstanceId
	1,  // 7: protobufs.MPxCommit.value:type_name -> protobufs.MPxValue
